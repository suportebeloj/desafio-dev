...
func (m *TransactionService) ListOperations(marketName string) ([]postgres.ListMarketTransactionRow, error) {
	result, err := m.dbService.ListMarketTransaction(context.Background(), marketName)
	if err != nil {
		return nil, err
	}
